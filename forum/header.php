...
<div class="navbar-fixed">
  ...
  <ul id="FS_Account" class="dropdown-content zpDropdown">
    <li><a href="account.php" class="dtText"><i class="material-icons left">account_circle</i>ACCOUNT</a></li>
    <li><a href="tracker.php" class="dtText"><i class="material-icons left">description</i>TRACKER</a></li>
    <li><a href="login.php?logout=true" class="dtText"><i class="material-icons left">error_outline</i>LOGOUT</a></li>
  </ul>
  <nav role="navigation">
      <div class="nav-wrapper navbar">
        ...
        <ul id="nav" class="right hide-on-med-and-down">
          ...
          <li><a href="#" class="waves-effect waves-light nav-btn">FORUM</a></li>
        ...
        <ul class="side-nav" id="nav-mobile">
          ...
          <li class="li-fill"><a href="#" class="waves-effect waves-light nav-btn ">FORUM</a></li>
